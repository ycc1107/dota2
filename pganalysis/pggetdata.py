...
sliced_data = ['slice1.txt', 'slice2.txt', 'slice3.txt', 'slice4.txt', 'slice5.txt', 'slice6.txt', 'slice7.txt',
               'slice8.txt', 'slice9.txt', 'slice10.txt', 'slice11.txt', ]
...
output_filename = 'stuns_per_min.csv'
mark = 1
...
for i2 in sliced_data:
    with open(i2, 'r') as ms:
        ...
        with open(output_filename,'w') as output_file:
            stuns = csv.writer(output_file)
            i=0
            for line in stuns_mat:
                stuns.writerow(stuns_mat[i])
                i+=1
